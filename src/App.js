  ...
  return (
   ...
   pb-2 rounded-md font-semibold text-white ml-10' onClick={() => {
      ...
      <div className='flex flex-col sm:flex-row'>
        <textarea type='text' className='bg-gray-200 w-screen sm:w-[50vw] h-[45vh] sm:h-[90vh] resize-none border-2 border-gray-300 outline-none' placeholder='ENTER YOUR VALID JSON DATA' value={data} onChange={(e) => setData(e.target.value)} />
        <div className='h-[45vh] sm:h-[90vh] overflow-auto w-screen sm:w-[50vw] '>
